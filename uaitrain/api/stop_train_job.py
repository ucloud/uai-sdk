...
class StopUAITrainJobApiOp(BaseUAITrainAPIOp):
    """
    StopUAITrainJobAPI
    ...
    def __init__(self, pub_key, priv_key, job_id, project_id="", region="", zone=""):
        super(StopUAITrainJobApiOp, self).__init__(self.ACTION_NAME, pub_key, priv_key, project_id, region, zone)
        self.cmd_params["TrainJobId"] = job_id

    def _check_args(self):
        super(StopUAITrainJobApiOp, self)._check_args()
