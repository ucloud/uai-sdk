...
class RemoveUAITrainJobOp(BaseUAITrainAPIOp):
    ACTION_NAME = "RemoveUAITrainJob"
    """
    RemoveUAITrainJobOp
        Compatable with UAI Train RemoveUAITrainJob API func
        Input:
    ...
    def __init__(self, pub_key, priv_key, job_id, project_id="", region="", zone=""):
        super(RemoveUAITrainJobOp, self).__init__(self.ACTION_NAME,
                                                     pub_key,
                                                     priv_key,
                                                     project_id,
                                                     region,
    ...
    def _check_args(self):
        super(RemoveUAITrainJobOp, self)._check_args()
