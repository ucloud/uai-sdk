...
# UCloud AI platform extra params
parser.add_argument('--work_dir',
                    type=str,
                    default="/data",
                    help='Default work path')
...
def main_worker(args):
    ...
    args.nprocs = int(os.environ['WORKER_GPU_NUM'])
    ...
    train_dataset = datasets.FakeData(transform=train_transform)
    val_dataset = datasets.FakeData(transform=val_transform)
