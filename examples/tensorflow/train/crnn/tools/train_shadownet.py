...
from crnnmodel import crnn_model
from local_utils import data_utils, log_utils
from global_configuration import config
from uaitrain.arch.tensorflow import uflag

tf.app.flags.DEFINE_string('dataset_dir','/data/data','data path')
...
def train_shadownet():
    ...
    images, labels, imagenames = decoder.read_features(ops.join(FLAGS.dataset_dir, 'train_feature.tfrecords'),
                                                       num_epochs=None)
    ...
    #print('initializa the net model')
    ...
    # Set tf summary
    tboard_save_path = FLAGS.output_dir+'/log'
    ...
    with sess.as_default():
        ...
        for epoch in range(train_epochs):
            logger.info('epoch is {:d}'.format(epoch))
