...
def get_experiment_fn():
  def _experiment_fn(run_config, hparams):
    classifier = build_estimator(FLAGS.output_dir, FLAGS.model_type, run_config)
    train_input_fn=functools.partial(
          input_fn,
          data_file=os.path.join(FLAGS.data_dir, FLAGS.train_data),
    ...
    eval_input_fn=functools.partial(
          input_fn,
          data_file=os.path.join(FLAGS.data_dir, FLAGS.test_data),
          num_epochs=1,
          shuffle=False,
          batch_size=FLAGS.batch_size)

    train_steps = FLAGS.train_epochs * _NUM_EXAMPLES['train'] // FLAGS.batch_size
    eval_steps = _NUM_EXAMPLES['validation'] // FLAGS.batch_size
