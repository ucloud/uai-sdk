...
(refer to: https://github.com/tensorflow/serving/blob/master/tensorflow_serving/example/inception_saved_model.py)
"""
...
def export():
  ...
  with tf.Graph().as_default():
    ...
    jpegs = tf.placeholder(tf.string, shape=[None,], name='tf_example')
